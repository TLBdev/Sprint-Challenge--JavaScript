...
let newArr = []
graduates.map(e => newArr.push(e.university))
const universities = newArr.sort();
...
*/
const displayNames = [];
zooAnimals.forEach(e => displayNames.push(`${e.animal_name}, ${e.scientific_name}`))
...
zooAnimals.map(e => lowCaseAnimalNames.push(e.animal_name.toLocaleLowerCase()))
...
*/
const newArr2 = []
zooAnimals.forEach(e => newArr2.push(e.population))
const populationTotal = newArr2.reduce((a, b) => a+b)
